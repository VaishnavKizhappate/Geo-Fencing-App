...
<body>
    ...
    <div class="clients_section layout_padding">
    	<div class="container">
    		<div class="row">
    		    <div class="col-sm-12">
    			    <div class="client_text"> <span style="color: #c6610f;">Add Rescue Members</span></div>
    			    <br><br><br><br>
                    ...
                    <div class="enput_bt" style="margin-bottom: 50px">
                        <div class="row">
                            ...
                            <div class="container">
                                <form action="add_rescue.php" method="post">
                                    <div class="form-group">
                                    <input type="text" class="email-bt" placeholder="District" name="district">
                                    </div>
                                    <div class="form-group">
                                    <input type="text" class="email-bt" placeholder="Area" name="area">
                                    </div>
                                    <div class="form-group">
                                    <input type="text" class="email-bt" placeholder="Name" name="name">
                                    </div>
                                    <div class="form-group">
                                    <input type="text" class="email-bt" placeholder="Contact" name="contact">
                                    </div>
                                    <div class="send_bt_main">
                                    <div class="left">
                                        <button type="submit" class="send_bt">ADD</button>
                                    </div>
                                </div>
                                <br><br>
                                </form>
    ...
    <div class="clients_section layout_padding">
    	<div class="container">
    		<div class="row">
    		    <div class="col-sm-12">
    			    <div class="client_text"> <span style="color: #c6610f;">Rescue Members</span></div>
    			    <br><br><br><br>
                    ...
                    <table border="1" align="center"> 
                                ...
                                include('config.php');
                              	...
                              	$query1="select * from rescue_team";
                    	        ...
                    	        while($row1=mysqli_fetch_array($res1))
                    	        {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="delete_rescue.php?id=<?php echo $id;?>"><li class="btn header-btn">Delete</li></a></td>
                                    </tr>
                                    <?php
                    	        }
                                ?>
