...
<body>
    ...
    <div class="clients_section layout_padding">
    	<div class="container">
    		<div class="row">
    		    <div class="col-sm-12">
    			    <div class="client_text"> <span style="color: #c6610f;">Add Area</span></div>
    			    <br><br><br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="container">
                                <form action="add_area.php" method="post">
                                    ...
                                    <input type="text" class="email-bt" placeholder="Latitude" name="latitude">
                                    </div>
                                    <div class="form-group">
                                    <input type="text" class="email-bt" placeholder="Longitude" name="longitude">
                                    </div>
                                    <div class="form-group">
                                    <input type="text" class="email-bt" placeholder="Radius" name="radius">
                                    </div>
    ...
    <div class="clients_section layout_padding">
    	<div class="container">
    		<div class="row">
    		    <div class="col-sm-12">
    			    <div class="client_text"> <span style="color: #c6610f;">Restricted Areas</span></div>
    			    <br><br><br><br>
                    ...
                    <table border="1" align="center"> 
                                ...
                                include('config.php');
                              	...
                              	$query1="select * from restricted_areas";
                    	        ...
                    	        while($row1=mysqli_fetch_array($res1))
                    	        {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="delete_area.php?id=<?php echo $id;?>"><li class="btn header-btn">Delete</li></a></td>
                                    </tr>
                                    <?php
                    	        }
                                ?>
