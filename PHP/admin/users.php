...
<body>
    ...
    <div class="clients_section layout_padding">
    	<div class="container">
    		<div class="row">
    		    <div class="col-sm-12">
    			    <div class="client_text"> <span style="color: #c6610f;">Users</span></div>
    			    <br><br><br><br>
                    ...
                    <table border="1" align="center"> 
                                ...
                                <td><h4>Phone</h4></td>
                                <td><h4>City</h4></td>
                                <td><h4>View last updated location</h4></td>
                                </tr>     
                    	        ...
                    	        while($row1=mysqli_fetch_array($res1))
                    	        {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $city;?></td>
                                        <?php if(!empty($lat)) { ?>
                                            <td><a href="https://www.google.com/maps/search/?api=1&query=<?php echo $lat;?>,<?php echo $lng;?>"><li class="btn header-btn">View </li></a></td>
                                        <?php } else { ?>
                                            <td>No location found</td>
                                        <?php } ?>
                                    </tr>
                                    <?php
                    	        }
